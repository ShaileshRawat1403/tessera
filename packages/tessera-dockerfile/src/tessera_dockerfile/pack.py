...
from tessera_dockerfile.compiler import load_records, validate_records, write_artifacts


class DockerfilePack(JobPack):
    name = "dockerfile"
    version = "0.2.0"
...
def create_pack() -> DockerfilePack:
    return DockerfilePack()
